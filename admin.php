...
<body>
    <nav class="navbar navbar-dark bg-dark">
            <span class="navbar-brand mb-0 h1">CGHM</span>
    </nav>
<div class="container">
    <br>
...
?>
        ...
        while ($data = mysqli_fetch_array($hasil)) {
            ...
            <tr>
                ...
                <td>
                    ...
                    <a href="admin.php?id_peserta=<?php echo htmlspecialchars($data['id_peserta']); ?>" class="btn btn-danger" role="button">Delete</a>
                </td>
            </tr>
            </tbody>
            <?php
    ...
    <a style="float:right; background:blue; color:white" href="logout.php" class="btn">Logout</a>
</div>
</body>
</html>
